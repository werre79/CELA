      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
          @for (service of servicesDisplay(); track service.title) {
            <div class="bg-white rounded-xl p-8 shadow-sm border border-slate-100 hover:shadow-md hover:border-amber-200 transition-all flex flex-col h-full">
...
export class ServicesComponent {
  ...
  // Налаштування іконок та кольорів для 4-х нових напрямків
  private serviceMetadata = [
    { icon: 'construction', colorClass: 'bg-amber-600' }, // Відбудова
    { icon: 'security', colorClass: 'bg-blue-600' },     // Безпека
    { icon: 'eco', colorClass: 'bg-green-600' },         // ESG
    { icon: 'gavel', colorClass: 'bg-orange-700' }       // Право
  ];
